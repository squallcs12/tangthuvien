...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounts_userprofile', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.birthday'
        db.alter_column(u'accounts_userprofile', 'birthday', self.gf('django.db.models.fields.DateField')(default=None))
