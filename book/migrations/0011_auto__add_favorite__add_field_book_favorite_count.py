...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'book_favorite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['book.Book'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('book', ['Favorite'])

        # Adding field 'Book.favorite_count'
        db.add_column(u'book_book', 'favorite_count',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'book_favorite')

        # Deleting field 'Book.favorite_count'
        db.delete_column(u'book_book', 'favorite_count')
