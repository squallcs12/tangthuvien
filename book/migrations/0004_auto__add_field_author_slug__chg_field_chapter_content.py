...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'book_author', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=255),
                      keep_default=False)


        # Changing field 'Chapter.content'
        db.alter_column(u'book_chapter', 'content', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'Author.slug'
        db.delete_column(u'book_author', 'slug')


        # Changing field 'Chapter.content'
        db.alter_column(u'book_chapter', 'content', self.gf('django.db.models.fields.TextField')())
