...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Chapter', fields ['book', 'number']
        db.delete_unique(u'book_chapter', ['book_id', 'number'])

        # Adding unique constraint on 'Chapter', fields ['book', 'number', 'language']
        db.create_unique(u'book_chapter', ['book_id', 'number', 'language_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Chapter', fields ['book', 'number', 'language']
        db.delete_unique(u'book_chapter', ['book_id', 'number', 'language_id'])

        # Adding unique constraint on 'Chapter', fields ['book', 'number']
        db.create_unique(u'book_chapter', ['book_id', 'number'])
