...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Copy'
        db.create_table(u'book_copy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('book', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['book.Book'], unique=True)),
            ('last_page', self.gf('django.db.models.fields.IntegerField')()),
            ('last_post', self.gf('django.db.models.fields.IntegerField')()),
            ('last_chapter_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('book', ['Copy'])


    def backwards(self, orm):
        # Deleting model 'Copy'
        db.delete_table(u'book_copy')
