...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserLog.chapter'
        db.delete_column(u'book_userlog', 'chapter_id')

        # Adding field 'UserLog.page'
        db.add_column(u'book_userlog', 'page',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserLog.chapter'
        db.add_column(u'book_userlog', 'chapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['book.Chapter']),
                      keep_default=False)

        # Deleting field 'UserLog.page'
        db.delete_column(u'book_userlog', 'page')
