...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.last_chapter_number'
        db.add_column(u'book_book', 'last_chapter_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.last_chapter_number'
        db.delete_column(u'book_book', 'last_chapter_number')
