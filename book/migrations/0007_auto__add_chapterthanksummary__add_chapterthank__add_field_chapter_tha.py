...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChapterThankSummary'
        db.create_table(u'book_chapterthanksummary', (
            ('chapter', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['book.Chapter'], unique=True, primary_key=True)),
            ('users', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('book', ['ChapterThankSummary'])

        # Adding model 'ChapterThank'
        db.create_table(u'book_chapterthank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chapter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['book.Chapter'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('book', ['ChapterThank'])

        # Adding field 'Chapter.thank_count'
        db.add_column(u'book_chapter', 'thank_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ChapterThankSummary'
        db.delete_table(u'book_chapterthanksummary')

        # Deleting model 'ChapterThank'
        db.delete_table(u'book_chapterthank')

        # Deleting field 'Chapter.thank_count'
        db.delete_column(u'book_chapter', 'thank_count')
    ...
    models = {
        ...
        'book.chapter': {
            ...
            'thank_count': ('django.db.models.fields.IntegerField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        'book.chapterthank': {
