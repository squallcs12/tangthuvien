...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.last_chapter_title'
        db.add_column(u'book_book', 'last_chapter_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.last_chapter_title'
        db.delete_column(u'book_book', 'last_chapter_title')
