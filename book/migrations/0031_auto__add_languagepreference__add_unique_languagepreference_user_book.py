...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LanguagePreference'
        db.create_table(u'book_languagepreference', (
        ...
        db.send_create_signal('book', ['LanguagePreference'])

        # Adding unique constraint on 'LanguagePreference', fields ['user', 'book']
        db.create_unique(u'book_languagepreference', ['user_id', 'book_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LanguagePreference', fields ['user', 'book']
        db.delete_unique(u'book_languagepreference', ['user_id', 'book_id'])

        # Deleting model 'LanguagePreference'
        db.delete_table(u'book_languagepreference')
    ...
    models = {
        ...
        'book.book': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'languages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['book.Language']", 'symmetrical': 'False'}),
        ...
        'book.chapter': {
            'Meta': {'unique_together': "(('book', 'number', 'language'),)", 'object_name': 'Chapter'},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['book.Book']"}),
        ...
        'book.languagepreference': {
            'Meta': {'unique_together': "(('user', 'book'),)", 'object_name': 'LanguagePreference'},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['book.Book']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
