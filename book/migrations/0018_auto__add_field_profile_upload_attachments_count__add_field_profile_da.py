...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.upload_attachments_count'
        db.add_column(u'book_profile', 'upload_attachments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Profile.daily_uploaded_attachments_count'
        db.add_column(u'book_profile', 'daily_uploaded_attachments_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.upload_attachments_count'
        db.delete_column(u'book_profile', 'upload_attachments_count')

        # Deleting field 'Profile.daily_uploaded_attachments_count'
        db.delete_column(u'book_profile', 'daily_uploaded_attachments_count')
