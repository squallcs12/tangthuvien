...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RatingLog.rating'
        db.add_column(u'book_ratinglog', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RatingLog.rating'
        db.delete_column(u'book_ratinglog', 'rating')
    ...
    models = {
        ...
        'book.rating': {
            ...
            'average_result': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
