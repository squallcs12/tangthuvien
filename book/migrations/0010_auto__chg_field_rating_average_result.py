...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.average_result'
        db.alter_column(u'book_rating', 'average_result', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Rating.average_result'
        db.alter_column(u'book_rating', 'average_result', self.gf('django.db.models.fields.FloatField')())
