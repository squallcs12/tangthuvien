...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.information'
        db.alter_column(u'book_author', 'information', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Book.description'
        db.alter_column(u'book_book', 'description', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'Author.information'
        db.alter_column(u'book_author', 'information', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Book.description'
        db.alter_column(u'book_book', 'description', self.gf('django.db.models.fields.TextField')())
