...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'book_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='book_profile', unique=True, to=orm['auth.User'])),
            ('chapters_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('book', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table(u'book_profile')
