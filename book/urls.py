...
from book.views.copy_book_view import CopyNewBookView
...
urlpatterns = patterns('book.views',
    ...
    url(r'^language/list', api_list_view.LanguageListView.as_view(), name="book_language_lists"),
    url(r'^language/book_preference', api_preference_view.LanguagePreferenceView.as_view(), name="book_language_preference"),
    ...
    url(r'^copy_book$', CopyNewBookView.as_view(), name='copy_book'),
    ...
    url(r'^test_cloned_notification/(?P<thread_id>\d*)', TestClonedBookNotificationView.as_view(), name='test_cloned_book_notification'),
    url(r'^cloned_notification/(?P<thread_id>\d*)/script.js', ClonedBookJsNotificationView.as_view(), name='cloned_book_notification'),
