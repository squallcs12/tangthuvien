...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'thankshop_useritem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thankshop.Item'])),
        ))
        db.send_create_signal('thankshop', ['UserItem'])

        # Adding unique constraint on 'UserItem', fields ['user', 'item']
        db.create_unique(u'thankshop_useritem', ['user_id', 'item_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserItem', fields ['user', 'item']
        db.delete_unique(u'thankshop_useritem', ['user_id', 'item_id'])

        # Deleting model 'UserItem'
        db.delete_table(u'thankshop_useritem')
