...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table(u'thankshop_item', (
            ...
            ('stocks', self.gf('django.db.models.fields.IntegerField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('thankshop', ['Item'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'thankshop_item')
